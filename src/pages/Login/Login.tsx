    ...
    <LoginLayout>
      <div>
        <div>
          ...
          <div className="title-description">아가리에 다짐을 외치면, N일 후 뱉은 말을 돌려드려요.</div>
        </div>
        ...
        <button className="kakao-button" type="button" onClick={kakaoLogin}>
          <img src={kakao_symbol} alt="kakao_symbol" />
          <span>카카오 로그인</span>
        </button>
  ...
  return (
    <div>
      <div className="title-description-bubble">
        <img className="bubble" src={speech_bubble} alt={speech_bubble} />
      ...
      <div className="count-users">현재까지 00명이 아가리에 외쳤어요!</div>
      <button className="kakao-button" type="button" onClick={kakaoLogin}>
        <img className="kakao-logo" src={kakao_symbol} alt="kakao_symbol" />
        <span>카카오 로그인</span>
      </button>
      <div className="terms-of-service">로그인 시 서비스 이용약관에 동의하게 됩니다.</div>
    </div>
