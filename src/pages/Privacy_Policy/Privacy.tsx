...
const PolicyArr = [
  `<h4>개인정보의 처리 목적 및 항목</h4>
    ...
    </div>또한, 서비스 이용과정에서 로그 분석을 통해 생성 정보가 수집될 수 있으며, 쿠키에 의한 정보 등이 자동으로 생성되어 수집될 수 있습니다.
    </div>`,
  ...
  `<h4>개인정보 처리업무 위탁에 관한 사항</h4>
    <div style='padding-left:10px;'>유어슈는 개인정보 처리업무를 위탁하고 있지 않습니다. 다만, 서비스 이용 및 통계 분석을 목적으로 로그 분석 툴인 Google Analytics 도구를 사용하고 있습니다.</div>`,
  ...
  `<h4>개인정보를 자동으로 수집하는 장치의 설치ㆍ운영 및 그 거부에 관한 사항</h4>
    ...
    <div style='padding-left:10px;'><div style='margin-top: 5px'>&#10625; 스마트폰의 광고 식별자 차단·허용 방법
    <div style='padding-left:10px;'>&#8728; Android : 설정 > 개인정보보호 > 광고 ID 재설정 또는 광고 ID 삭제
    &#8728; iPhone : 설정 > 개인정보보호 > 추적 > 앱이 추적을 요청하도록 허용 끔</div></div><div style='margin-top: 5px'>&#10625; 웹브라우저를 통한 맞춤형 광고 차단·허용
